...
namespace Ifa.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApprenticeshipStandard :  IEquatable<ApprenticeshipStandard>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApprenticeshipStandard" /> class.
        /// </summary>
        ...
        public ApprenticeshipStandard(int? iD = default(int?), string referenceNumber = default(string), string title = default(string), string status = default(string), string uri = default(string), string standardPageUri = default(string), DateTime? publishedDate = default(DateTime?), string overviewOfRole = default(string), int? level = default(int?), int? duration = default(int?), int? maxFunding = default(int?), string category = default(string), List<string> keywords = default(List<string>), List<string> jobRoles = default(List<string>), string entryRequirements = default(string), string qualifications = default(string), string whatApprenticesWillLearn = default(string), string occupationalStandardUrl = default(string), string assessmentPlanUrl = default(string), TypicalLength typicalLength = default(TypicalLength), string ssa1 = default(string), string ssa2 = default(string))
        {
            this.ID = iD;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApprenticeshipStandard {\n");
        ...
        {
            return this.Equals(input as ApprenticeshipStandard);
        }

        /// <summary>
        /// Returns true if ApprenticeshipStandard instances are equal
        /// </summary>
        /// <param name="input">Instance of ApprenticeshipStandard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApprenticeshipStandard input)
        {
            if (input == null)
                return false;
