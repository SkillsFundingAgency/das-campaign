...
namespace Ifa.Api.Model
{
    ...
    public partial class ApiApprenticeshipStandard :  IEquatable<ApiApprenticeshipStandard>, IValidatableObject
    {
        ...
        public List<ApiQualificationDataModel> Qualifications { get; set; }
