        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            context.Response.Headers.AddIfNotPresent(
                ...
                new StringValues(
                    ...
                    $"connect-src wss://localhost:* bat.bing.com https://t.co https://*.mktoresp.com https://*.doubleclick.net https://*.linkedin.com https://*.snapchat.com https://consent-api-bgzqvpmbyq-nw.a.run.app https://*.google-analytics.com https://*.clarity.ms https://*.zendesk.com https://*.zdassets.com wss://*.zopim.com https://*.rcrsv.io ;"));
