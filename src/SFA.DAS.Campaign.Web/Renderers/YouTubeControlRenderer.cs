    ...
    public class YouTubeControlRenderer : IControlRenderer
    {
        ...
        public HtmlString Render(IHtmlControl content)
        {
            ...
            parentDiv.InnerHtml.AppendHtml(
                $"<div class=\"fiu-video-player__inner-wrap\"><iframe class=\"fiu-video-player__size-100\" frameborder=\"0\" src=\"{control.Url.Replace("watch?v=", "embed/")}?cc_load_policy=1\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe></div>");
