...
namespace VacanciesApi
{
    ...
    /// <summary>
    /// </summary>
    public partial interface ILivevacanciesAPI : System.IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// The apprenticeship operation retrieves a single live apprenticeship
        /// vacancy using the vacancy reference number.
        ///
        /// Note that:
        ///
        ...
        /// #### Error codes ####
        ///
        /// The following error codes may be returned when calling this
        /// operation:
        ///
        ...
        /// </param>
        Task<HttpOperationResponse<object>> FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixNineWithHttpMessagesAsync(string vacancyReference, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// GetTraineeshipVacancy
        /// </summary>
        /// <remarks>
        /// The traineeship operation retrieves a single live traineeship
        /// vacancy using the vacancy reference number.
        ///
        /// Note that:
        ///
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixaWithHttpMessagesAsync(string vacancyReference, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));

        /// <summary>
        /// SearchApprenticeshipVacancies
        /// </summary>
        /// <remarks>
        /// The apprenticeship search operation retrieves live apprenticeship
        /// vacancies based on search criteria specified
        ...
        /// If the search yields more data than can be included in a single
        /// page then additional pages can be requested by
        ...
        /// ```
        ///
        /// Multiple standard codes can be specified by using a comma delimited
        ...
        ///
        /// Multiple parameters can be added to the query string to refine the
        /// search.
        /// Note that when specifying both framework and standard codes, the
        /// results will include vacancies with matching
        /// framework or standard codes.
        ///
        /// #### Sorting results ####
        ///
        /// The results will be ordered by the following rules by default:
        /// - If searching by geo-location then the results are sorted by
        /// distance (closest first).
        /// - If searching by anything other than geo-location then the results
        /// are sorted by age (posted date) (newest first).
        ///
        /// The default sorting rules can be overriden by using the `SortBy`
        /// query parameter.
        /// SortBy can be set to "Age", "Distance" or "ExpectedStartDate".
        /// Whereas sorting by "Age" will return newest vacancies first,
        /// sorting by "ExpectedStartDate" will return vacancies that have
        /// earliest start date first.
        /// Beware that it is invalid to sort by distance if you have not
        /// searched by geo-location.
        ///
        /// #### Error codes ####
        ///
        /// The following error codes may be returned when calling this
        /// operation if any of the search criteria values
