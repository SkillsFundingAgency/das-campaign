...
namespace VacanciesApi
{
    ...
    public static partial class LivevacanciesAPIExtensions
    {
            ...
            /// </param>
            public static object FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixNine(this ILivevacanciesAPI operations, string vacancyReference)
            {
                return operations.FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixNineAsync(vacancyReference).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<object> FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixNineAsync(this ILivevacanciesAPI operations, string vacancyReference, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixNineWithHttpMessagesAsync(vacancyReference, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <param name='vacancyReference'>
            /// </param>
            public static object FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixa(this ILivevacanciesAPI operations, string vacancyReference)
            {
                return operations.FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixaAsync(vacancyReference).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixaAsync(this ILivevacanciesAPI operations, string vacancyReference, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixaWithHttpMessagesAsync(vacancyReference, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixbAsync(this ILivevacanciesAPI operations, string standardLarsCodes = default(string), string frameworkLarsCodes = default(string), int? pageSize = default(int?), int? pageNumber = default(int?), int? postedInLastNumberOfDays = default(int?), bool? nationwideOnly = default(bool?), double? latitude = default(double?), double? longitude = default(double?), int? distanceInMiles = default(int?), string sortBy = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.FivebFivefZeroNineFiveeaSevenNinedNinedOneZeroFivecEightEightdfSixbWithHttpMessagesAsync(standardLarsCodes, frameworkLarsCodes, pageSize, pageNumber, postedInLastNumberOfDays, nationwideOnly, latitude, longitude, distanceInMiles, sortBy, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
