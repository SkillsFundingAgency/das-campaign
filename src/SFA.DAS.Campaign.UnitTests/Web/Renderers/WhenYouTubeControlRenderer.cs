...
namespace SFA.DAS.Campaign.UnitTests.Web.Renderers
{
    public class WhenYouTubeControlRenderer
    {
        ...
        public void Is_Passed_An_Object_Of_YouTube_Then_Render_Returns_The_Html(YouTubeControlRenderer renderer)
        {
            ...
            actual.Value.Should().Be("<div class=\"fiu-video-player\"><div class=\"fiu-video-player__inner-wrap\"><iframe class=\"fiu-video-player__size-100\" frameborder=\"0\" src=\"http://yt.video?cc_load_policy=1\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe></div></div>");
        }
    }
}
