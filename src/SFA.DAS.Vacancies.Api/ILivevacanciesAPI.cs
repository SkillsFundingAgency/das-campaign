...
namespace VacanciesApi
{
    ...
    public partial interface ILivevacanciesAPI : System.IDisposable
    {
        ...
        /// </param>
        Task<HttpOperationResponse<object>> GetApprenticeshipVacancyAsync(string vacancyReference, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object>> GetTraineeshipVacancyAsync(string vacancyReference, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
